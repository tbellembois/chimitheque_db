...
pub const HAZARD_STATEMENTS: [(&str, &str); 98] = [
...
(".Contains epoxy pub constituents. See information supplied by the manufacturer.", "EUH205"), 
...
(".May cause cancer <state route of exposure if it is conclusively proven that no other routes of exposure cause the hazard>.", "H350	C"),
(".May cause cancer by inhalation.", "H350i	C"),
...
(".May cause genetic defects <state route of exposure if it is conclusively proven that no other routes of exposure cause the hazard>.", "H340	M"),
...
(".May damage fertility or the unborn child <state specific effect if known > <state route of exposure if it is conclusively proven that no other routes of exposure cause the hazard>.", "H360	R"),
(".May damage fertility.", "H360F	R"),
(".May damage fertility. May damage the unborn child.", "H360FD	R"),
(".May damage fertility. Suspected of damaging the unborn child.", "H360Fd	R"),
(".May damage the unborn child.", "H360D	R"),
(".May damage the unborn child. Suspected of damaging fertility.", "H360Df	R"),
...
(".Suspected of causing cancer <state route of exposure if it is conclusively proven that no other routs of exposure cause the hazard>.", "H351	C"),
(".Suspected of causing genetic defects <state route of exposure if it is conclusively proven that no other routes of exposure cause the hazard>.", "H341	M"),
(".Suspected of damaging fertility or the unborn child <state specific effect if known> <state route of exposure if it is conclusively proven that no other routes of exposure cause the hazard>.", "H361	R"),
(".Suspected of damaging fertility.", "H361f	R"),
(".Suspected of damaging fertility. Suspected of damaging the unborn child.", "H361fd	R"),
(".Suspected of damaging the unborn child.", "H361d	R"),
...
pub const CMR_CAS: [(&str, &str); 1473] = [
    ("100-00-5", "C2 M2"),
    ("100-40-3", "C2"),
    ("100-42-5", "R2"),
    ("100-44-7", "C1B"),
